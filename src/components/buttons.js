 ...
 */
export function paginationButtons(currentPage, totalPages, customIdPrefix = 'page') {
 ...
 */
export function actionButton(customId, label, emoji = null, style = ButtonStyle.Primary) {
 ...
 */
export function dailyClaimButton(canClaim = true) {
    return new ActionRowBuilder()
        .addComponents(
            new ButtonBuilder()
