...
export default {
    ...
    async execute(interaction) {
        const embed = customEmbed({
            ...
            fields: [
                { name: '🛡️ Moderation', value: 'Server management commands', inline: true },
                { name: '💰 Economy', value: 'Currency and shop commands', inline: true },
        ...
        const menuInteraction = await awaitSelectMenu(message, interaction.user.id, 60);
